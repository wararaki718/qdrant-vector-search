...
from qdrant_client.models import PointStruct, ScoredPoint, UpdateResult, SparseVectorParams, SearchRequest, VectorParams
...
class SearchClient:
    ...
    def create_index(self, collection_name: str, vectors_config: Dict[str, VectorParams], sparse_vectors_config: Dict[str, SparseVectorParams]) -> bool:
